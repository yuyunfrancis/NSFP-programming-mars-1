...
class Product:
    ...
    def to_json(self) -> str:
        ...
        return json.dumps({"code": self.code, "name": self.name, "brand": self.brand,
                            "quantity":self.quantity, "category":self.category, "description": self.description,
                             "price": self.price, "dosage_instruction": self.dosage_instruction,
